...
exports.TscCommand = void 0;
class TscCommand {
    constructor(textEncoding) {
     ...
     */
    setSize(pageWidght, pageHeight) {
        const data = 'SIZE ' + pageWidght.toString() + ' mm' + ',' + pageHeight.toString() + ' mm' + '\r\n';
   ...
   */
     ...
     */
    setBox(x, y, endX, endY, thickness) {
     ...
     * content 打印内容
     */
    setBarCode(x, y, codetype, height, readable, rotation, narrow, wide, content) {
        const data =
            'BARCODE ' +
            x +
            ',' +
     ...
     * content  内容
     */
    setQrcode(x, y, level, width, mode, content) {
        const data =
