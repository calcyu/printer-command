export class EscCommand {
    ...
    constructor(private textEncoder: { encode(content: string): Uint8Array }) {}
     ...
     * 1mm=8dot
     */
    setAbsolutePrintPosition(where: number) {
        this.data.push(27);
        this.data.push(36);
     ...
     * 1mm=8dot
     */
    setRelativePrintPositon(where: number) {
        // 设置相对横向打印位置
        this.data.push(27);
        this.data.push(92);
        this.data.push(Math.floor(where % 256));
     ...
     * • 当n 为2 时  右对齐
     */
    setSelectJustification(which: number) {
        this.data.push(27);
        this.data.push(97);
     ...
     * 1mm=8dot
     */
    setPrintingAreaWidth(width: number) {
        this.data.push(29);
        this.data.push(87);
     ...
     * 1mm=8dot
     */
    setHorizontalAndVertical(x: number, y: number) {
        this.data.push(29);
        this.data.push(80);
        this.data.push(x);
        this.data.push(y);
   ...
   */
    setCashboxPulse(n: number, m: number, t: number) {
        this.data.push(16);
        this.data.push(20);
        this.data.push(n);
        this.data.push(m);
     ...
     * • 当m 为1 时，钱箱插座的引脚5
     */
    setCashCashboxPulse(m: number, t1: number, t2: number) {
        this.data.push(27);
        this.data.push(112);
        this.data.push(m);
        this.data.push(t1);
     ...
     * 1mm=8dot
     */
    setCharacterRightSpace(n: number) {
        this.data.push(27);
        this.data.push(32);
        this.data.push(n);
        return this;
     ...
     * • 当n 为1 时，使用用户自定义字符。
     */
    setUserDefinitionCharacter(n: number) {
        this.data.push(27);
        this.data.push(37);
        this.data.push(n);
        return this;
     ...
     */
    setCancleUserDefinitionCharacter(n: number) {
        this.data.push(27);
        this.data.push(63);
        this.data.push(n);
        return this;
     ...
     * • 当n 位为15 时， 选择中国
     */
    setInternationalCharacters(n: number) {
        this.data.push(27);
        this.data.push(82);
        this.data.push(n);
        return this;
  ...
  */
  ...
  单色图片整图转成一张bitmap
  */
    private convertToSingleBitmap(res: { width: number; height: number; data: [] }) {
        console.log(res);
        const w = res.width;
        const h = res.height;
     ...
     *
     */
    setBitmap(res: { width: number; height: number; data: [] }) {
        // 参数，画布的参数
        console.log(res);
     ...
     * • 当n 位为3 时，条码上、下方
     */
    setHRIPosition(position: number) {
        this.data.push(29);
        this.data.push(72);
     ...
     * 1 ≤ n ≤ 255
     */
    setBarcodeHeight(height: number) {
        this.data.push(29);
        this.data.push(104);
     ...
     * content：内容
     */
    setBarcodeContent(t: string, content: number) {
        let ty = 73;
        this.data.push(29);
        this.data.push(107);
        switch (t) {
     ...
     * • 当n 位为128 时，选择下划线
     */
    setChineseCharacterMode(n: number) {
        this.data.push(28);
        this.data.push(33);
        this.data.push(n);
        return this;
     ...
     * 传入点数，1mm=8dot
     */
    setChineseCharacterSpace(n1: number, n2: number) {
        this.data.push(28);
        this.data.push(83);
        this.data.push(n1);
        this.data.push(n2);
     ...
     */
    setChineseCharacteHeightWidth(n: number) {
        this.data.push(28);
        this.data.push(87);
        this.data.push(n);
        return this;
     ...
     * 0 ≤ n ≤ 1700
     */
    setBlackMaskOffset(p: number, a: number, m: number, n: number) {
        this.data.push(29);
        this.data.push(40);
        this.data.push(70);
     ...
     */
    setOrderTip(m: number, t: number, n: number) {
        this.data.push(27);
        this.data.push(67);
        if (m < 0) {
            m = 1;
     ...
     * [默认值] n = 3
     */
    setSelectSizeOfModuleForQRCode(n: number) {
        // 设置二维码大小
        this.data.push(29);
        this.data.push(40);
        this.data.push(107);
     ...
     * 51    选择纠错等级  H 30
     */
    setSelectErrorCorrectionLevelForQRCode(n: number) {
        this.data.push(29);
        this.data.push(40);
        this.data.push(107);
        this.data.push(3);
     ...
     */
    setStoreQRCodeData(content: string) {
        const code = this.textEncoder.encode(content);
        this.data.push(29);
        this.data.push(40);
        this.data.push(107);
    ...
    getRealtimeStatusTransmission(n: number) {
        // 查询打印机实时状态
        /*
    n = 1：传送打印机状态
    n = 2：传送脱机状态
